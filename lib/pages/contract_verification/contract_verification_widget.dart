...
import 'contract_verification_model.dart';
export 'contract_verification_model.dart';
...
class ContractVerificationWidget extends StatefulWidget {
  ...
  @override
  State<ContractVerificationWidget> createState() =>
      _ContractVerificationWidgetState();
}

class _ContractVerificationWidgetState
    extends State<ContractVerificationWidget> {
  late ContractVerificationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContractVerificationModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CropsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CropsRecord> contractVerificationCropsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final contractVerificationCropsRecord =
            contractVerificationCropsRecordList.isNotEmpty
                ? contractVerificationCropsRecordList.first
                : null;
