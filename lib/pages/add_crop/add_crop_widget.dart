...
class _AddCropWidgetState extends State<AddCropWidget> {
  ...
  void initState() {
    ...
    _model.priceperunitTextController ??= TextEditingController();
    _model.priceperunitFocusNode ??= FocusNode();
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            validator: _model.croptypeTextControllerValidator
                                .asValidator(context),
                            inputFormatters: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: SizedBox(
                            width: MediaQuery.sizeOf(context).width * 0.8,
                            child: TextFormField(
                              controller: _model.priceperunitTextController,
                              focusNode: _model.priceperunitFocusNode,
                              autofocus: false,
                              textInputAction: TextInputAction.next,
                              obscureText: false,
                              decoration: InputDecoration(
                              ...
                              cursorColor:
                                  FlutterFlowTheme.of(context).primaryText,
                              validator: _model
                                  .priceperunitTextControllerValidator
                                  .asValidator(context),
                              inputFormatters: [
                                FilteringTextInputFormatter.allow(
                                    RegExp('[0-9]'))
                      ...
                      Padding(
                        ...
                        child: Text(
                          valueOrDefault<String>(
                            FFAppState().latlong?.toString(),
                            'Getting your location details',
                          ),
                          style:
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            var cropsRecordReference =
                                CropsRecord.collection.doc();
                            await cropsRecordReference
                                .set(createCropsRecordData(
                              farmerId: FFAppState().userId,
                              cropType: _model.croptypeTextController.text,
                            ...
                            safeSetState(() {
                              _model.croptypeTextController?.clear();
                              _model.quantityTextController?.clear();
                              _model.priceperunitTextController?.clear();
