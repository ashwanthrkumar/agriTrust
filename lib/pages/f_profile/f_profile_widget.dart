...
class _FProfileWidgetState extends State<FProfileWidget> {
  ...
  void initState() {
    ...
    _model.phnoTextController1 ??= TextEditingController();
    _model.phnoFocusNode1 ??= FocusNode();

    _model.phnoTextController2 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.address, '') == ''
            ? 'Enter your address'
            : valueOrDefault(currentUserDocument?.address, ''));
    _model.phnoFocusNode2 ??= FocusNode();
  }
                          ...
                          Align(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => ClipRRect(
                                ...
                                child: Image.network(
                                  currentUserPhoto == ''
                                      ? 'https://previews.123rf.com/images/sarahdesign/sarahdesign1509/sarahdesign150901050/44517597-upload-button-upload-icon.jpg'
                                      : currentUserPhoto,
                                  width: 100.0,
                                  height: 100.0,
                                  fit: BoxFit.cover,
                          ...
                          Expanded(
                            child: AuthUserStreamWidget(
                              builder: (context) => SizedBox(
                                width: 200.0,
                                child: TextFormField(
                                  controller: _model.phnoTextController1,
                                  focusNode: _model.phnoFocusNode1,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    isDense: true,
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primaryText,
                                  validator: _model.phnoTextController1Validator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                          ...
                          StreamBuilder<List<UsersRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return InkWell(
                                ...
                                onTap: () async {
                                  _model.phno = int.tryParse(
                                      _model.phnoTextController1.text);
                                  safeSetState(() {});

                                  await iconUsersRecord!.reference
                                      .update(createUsersRecordData(
                                    phoneNumber: _model.phno?.toString(),
                                  ));
                                },
                                child: Icon(
                                  Icons.edit,
                          ...
                          Expanded(
                            child: AuthUserStreamWidget(
                              builder: (context) => SizedBox(
                                width: 200.0,
                                child: TextFormField(
                                  controller: _model.phnoTextController2,
                                  focusNode: _model.phnoFocusNode2,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    isDense: true,
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primaryText,
                                  validator: _model.phnoTextController2Validator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                          ...
                          StreamBuilder<List<UsersRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return InkWell(
                                ...
                                onTap: () async {
                                  _model.phno = int.tryParse(
                                      _model.phnoTextController2.text);
                                  safeSetState(() {});

                                  await iconUsersRecord!.reference
                                      .update(createUsersRecordData(
                                    phoneNumber: iconUsersRecord.address,
                                  ));
                                },
                                child: Icon(
                                  Icons.edit,
