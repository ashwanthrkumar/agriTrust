...
import '/pages/no_crop_found_b/no_crop_found_b_widget.dart';
...
import 'buyer_d_model.dart';
export 'buyer_d_model.dart';

class BuyerDWidget extends StatefulWidget {
  const BuyerDWidget({super.key});

  @override
  State<BuyerDWidget> createState() => _BuyerDWidgetState();
}

class _BuyerDWidgetState extends State<BuyerDWidget> {
  late BuyerDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuyerDModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().page = 'HomeB';
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CropsRecord>>(
      stream: queryCropsRecord(
        queryBuilder: (cropsRecord) => cropsRecord
            .where(
              'status',
              isEqualTo: 'Available',
            )
                    ...
                    children: [
                      ...
                      if (!FFAppState().searchIsActive)
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final nosearch = buyerDCropsRecordList.toList();
                              if (nosearch.isEmpty) {
                                return const NoCropFoundBWidget();
                              }
