...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const FORbWidget() : const StartPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'fORb',
          path: '/fORb',
          builder: (context, params) => const FORbWidget(),
        ),
        FFRoute(
          name: 'farmerD',
          path: '/farmerD',
          builder: (context, params) => const FarmerDWidget(),
        ),
        FFRoute(
          name: 'buyerD',
          path: '/buyerD',
          builder: (context, params) => const BuyerDWidget(),
        ),
        FFRoute(
          name: 'fContracts',
          path: '/fContracts',
          builder: (context, params) => const FContractsWidget(),
        ),
        FFRoute(
          name: 'addCrop',
          path: '/addCrop',
        ...
        FFRoute(
          name: 'fPayment',
          path: '/fPayment',
          builder: (context, params) => const FPaymentWidget(),
        ),
        FFRoute(
          name: 'fProfile',
          path: '/fProfile',
